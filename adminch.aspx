<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminch.aspx.cs" Inherits="QuickPharm360.adminch" %>
...
<head>
		<meta charset="utf-8">
		<title>Admin Chat Platform</title>
							...
							<div class="tab-content">
								...
								<div id="discussions" class="tab-pane fade active show">
									...
									<div class="list-group sort">
                                        ...
                                        <asp:Button ID="BtnLoadAll" runat="server" CssClass="btn filterDiscussionsBtn active show" Text="All" OnClick="BtnLoadAll_Click"></asp:Button>
										<%--<button class="btn filterDiscussionsBtn" data-toggle="list" data-filter="read">New</button>--%>
                                        <asp:Button ID="BtnLoadNew" runat="server" CssClass="btn filterDiscussionsBtn" Text="New" OnClick="BtnLoadNew_Click"></asp:Button>
										<%--<button class="btn filterDiscussionsBtn" data-toggle="list" data-filter="unread">Ongoing</button>--%>
                                        <asp:Button ID="BtnLoadOngoing" runat="server" CssClass="btn filterDiscussionsBtn" Text="Ongoing" OnClick="BtnLoadOngoing_Click"></asp:Button>
									</div>		
									<div class="discussions">
										<h1><asp:Label ID="LblClientChat" runat="server" Text="Clients Chats"></asp:Label></h1>
										<div class="list-group" id="chats" role="tablist">
                                            <asp:PlaceHolder ID="PlaceHolderChatList" runat="server" />
											<a href="#" class="filterDiscussions all unread single active" id="list-chat-list" data-toggle="list" role="tab"">
												...
												<div class="data">
													<h5>Janette Dalton</h5>
                                                    <h5><asp:LinkButton ID="LinkButton1" runat="server">Janette Dalton</asp:LinkButton></h5>
                                                    <span>Mon</span>
													<p>A new feature has been updated to your account. Check it out...</p>
												</div>
											</a>
                                                                            
                                          <asp:Button ID="BtnView07055995767" CssClass="btn-success" runat="server" Text="View Janette Dalton" OnClientClick="SetSource(this.id)"></asp:Button>	
									...
									<div class="container">
										<div class="col-md-12">
											<div class="inside">
												...
												<div class="data">
													<h5><a href="#"><asp:Label ID="LblSelectName" runat="server" Text="Label"></asp:Label></a></h5>
